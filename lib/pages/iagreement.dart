...
class InvAgreement extends StatefulWidget {
  const InvAgreement({Key? key}) : super(key: key);

  @override
  State<InvAgreement> createState() => _InvAgreementState();
}

class _InvAgreementState extends State<InvAgreement> {
  ...
  void _submitForm() async {
    ...
    try {
      ...
      // Navigate back to FarmerList page
      Navigator.of(context).pop();
  ...
  Future<List<Map<String, dynamic>>> fetchInvestors() async {
    try {
      ...
      // .where('userUUID', isEqualTo: 7337649008 )
          .get();
